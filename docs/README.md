**ggtype API Documentation v0.4.8**
...
- [HandleStream](interfaces/HandleStream.md)
...
- [SendErrorOptions](interfaces/SendErrorOptions.md)
- [SendMessageToClient](interfaces/SendMessageToClient.md)
- [Action](type-aliases/Action.md)
- [ActionFn](type-aliases/ActionFn.md)
- [ActionNotGeneric](type-aliases/ActionNotGeneric.md)
...
- [handleClientActions](functions/handleClientActions.md)
...
- [RouterClientOptions](type-aliases/RouterClientOptions.md)
...
- [TestRouter](interfaces/TestRouter.md)
...
- [createTestRouter](functions/createTestRouter.md)
...
- [isHttpTransport](functions/isHttpTransport.md)
